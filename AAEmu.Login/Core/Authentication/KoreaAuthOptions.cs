...
/// <summary>
/// Configuration options for Korea challenge-response authentication (V2, AES-256 with sha256_crypt key)
/// </summary>
/// <remarks>
...
{
    public const string ConfigurationSectionName = "KoreaAuth";
