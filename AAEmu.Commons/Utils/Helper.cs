...
{
    private static ConcurrentDictionary<Tuple<object, int>, DateTime> intervals = new(); // ConcurrentDictionary с корректной логикой обновления вместо Dictionary. После этого те рандомные вылеты по InvalidOperationException должны исчезнуть.
