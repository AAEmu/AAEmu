...
CREATE TABLE `accounts` (
  ...
  `last_updated` DATETIME NOT NULL DEFAULT CURRENT_TIME ON UPDATE CURRENT_TIME,
  `last_login` DATETIME NOT NULL DEFAULT CURRENT_TIME,
  `last_labor_tick` DATETIME NOT NULL DEFAULT CURRENT_TIME,
  `last_credits_tick` DATETIME NOT NULL DEFAULT CURRENT_TIME,
  `last_loyalty_tick` DATETIME NOT NULL DEFAULT CURRENT_TIME,
...
CREATE TABLE `characters` (
  ...
  `slots` blob NOT NULL,
  `created_at` datetime(0) NOT NULL DEFAULT CURRENT_TIME,
...
CREATE TABLE `expedition_members` (
  ...
  `last_leave_time` datetime NOT NULL DEFAULT CURRENT_TIME,
...
CREATE TABLE `housings` (
  ...
  `place_date` datetime NOT NULL DEFAULT CURRENT_TIME,
  `protected_until` datetime NOT NULL DEFAULT CURRENT_TIME,
...
CREATE TABLE `slaves` (
	...
	`created_at` DATETIME NULL DEFAULT CURRENT_TIME,
	`updated_at` DATETIME NULL DEFAULT CURRENT_TIME,
...
CREATE TABLE `audit_ics_sales` (
    ...
    `sale_date` DATETIME NOT NULL DEFAULT CURRENT_TIME COMMENT 'Time of purchase (in UTC)',
