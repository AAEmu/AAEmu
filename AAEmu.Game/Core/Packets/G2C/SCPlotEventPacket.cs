...
namespace AAEmu.Game.Core.Packets.G2C
{
    public class SCPlotEventPacket : GamePacket
    {
        ...
        public SCPlotEventPacket(ushort tl, uint eventId, uint skillId, PlotObject caster, PlotObject target, uint unkId, ushort castingTime,
