...
public static class WeatherClientPackets
{
    ...
    /// Native 10.0.2.13 copies the blob into ClientPlayer in handler the native loader, then
    /// <c>OnLoadingWorldComplete</c> at the native loader applies its snow bit during world load.
    /// </summary>
