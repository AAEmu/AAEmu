...
/// <summary>
/// Acknowledges one reopen-box reward claim.
/// </summary>
/// <remarks>
/// Field order, widths and names come from the 10.0.2.13 serializer, which passes each value's
/// name alongside the value: s16 ErrorMessage only - the same fixed shape as the reopen-box
...
/// </remarks>
public class SCReopenRandomBoxGetItemPacket(short errorMessage)
    : GamePacket(SCOffsets.SCReopenRandomBoxGetItemPacket, 1)
{
