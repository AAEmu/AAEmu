...
namespace AAEmu.Game.Core.Packets.G2C
{
    public class X2EnterWorldResponsePacket : GamePacket
    {
        ...
        public X2EnterWorldResponsePacket(short reason, uint token, ushort port, GameConnection connection)
        ...
        public override PacketStream Write(PacketStream stream)
        {
            ...
            //stream.Write(_gm);                 // GM 0 the field is in 3.0.3.0, but not in 3.5.5.3
