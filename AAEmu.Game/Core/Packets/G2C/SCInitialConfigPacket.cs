...
namespace AAEmu.Game.Core.Packets.G2C
{
    ...
    {
        public SCInitialConfigPacket() : base(0x006, 1)
        {
        }
        ...
        public override PacketStream Write(PacketStream stream)
        {
            ...
            stream.Write(new byte[] {0x3E, 0x32, 0x0F, 0x0F, 0x79, 0x00, 0x33, 0x00, 0x00, 0x00, 0x00}, true); // fset
            // TODO mb fset is BitArray, but if send all zero byte, lp is 1000, if fset from 1.0, lp is 2000, hm..., and this affects to prem, sieage, etc...
