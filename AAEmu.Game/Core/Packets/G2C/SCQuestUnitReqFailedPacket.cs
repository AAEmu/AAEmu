...
/// </summary>
/// <remarks>
/// Body serializer x2game-dev.dll 0x39C5E830: <c>type</c> (the quest context id) as a 4-byte int,
/// <c>bc</c> as the three-byte object id, then the result through 0x3938FDF0, which is the skill cast
...
/// The handler 0x394D1B40 hands it to 0x397BBB60, which acts only when <c>bc</c> is the local player:
/// it formats the result through the skill-result display path 0x397EBE90 (which drops results above
