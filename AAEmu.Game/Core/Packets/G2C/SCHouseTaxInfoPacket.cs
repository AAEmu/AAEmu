...
namespace AAEmu.Game.Core.Packets.G2C
{
    public class SCHouseTaxInfoPacket : GamePacket
    {
        ...
        public SCHouseTaxInfoPacket(ushort tl, int dominionTaxRate, int hostileTaxRate, int moneyAmount, int moneyAmount2,
            DateTime due, bool isAlreadyPaid, int weeksWithoutPay, int weeksPrepay,bool isHeavyTaxHouse)
            : base(SCOffsets.SCHouseTaxInfoPacket, 5)
        {
            _tl = tl;
