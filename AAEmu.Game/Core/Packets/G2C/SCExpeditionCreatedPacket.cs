...
public class SCExpeditionCreatedPacket : GamePacket
{
    ...
    public SCExpeditionCreatedPacket(SystemFaction faction, uint ownerObjId, (uint memberObjId, uint memberId, string name)[] members) :
        base(SCOffsets.SCExpeditionCreatedPacket, 5)
    {
        _faction = faction;
