...
/// <summary>
/// Carries a developer-only fake buy request. The 10.x body is a type and a signed count; there is
...
public class CSFakeBuySpecialtyItemPacket() : GamePacket(CSOffsets.CSFakeBuySpecialtyItemPacket, 1)
{
    ...
    public override void Execute()
    {
        SpecialtyManager.Instance.RejectFakeSpecialtyOperation(
            Connection?.ActiveChar, SpecialtyFakeOperationKind.Buy, TypeValue, ItemCount);
    }
