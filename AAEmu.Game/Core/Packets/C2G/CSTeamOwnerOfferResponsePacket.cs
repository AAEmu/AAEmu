...
/// <remarks>
/// </remarks>
public class CSTeamOwnerOfferResponsePacket() : GamePacket(CSOffsets.CSTeamOwnerOfferResponsePacket, 1)
{
    public override void Read(PacketStream stream)
    {
        ...
        TeamManager.Instance.RespondToOwnerHandover(
            Connection.ActiveChar, teamId, ownerId, candidateId, reason, accept, false);
    }
}
