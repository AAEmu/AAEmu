...
namespace AAEmu.Game.Core.Packets.C2G
{
    ...
    {
        public CSRequestMusicNotesPacket() : base(CSOffsets.CSRequestMusicNotes, 1)
        {
        }
        ...
        public override void Read(PacketStream stream)
        {
            ...
            _log.Debug("Request Song, id: {0}, value2:{1}", id64, value2);
            if (value2 == 1)
            {
            ...
            {
                Connection.ActiveChar.Buffs.AddBuff(6010, Connection.ActiveChar); // Score Memorized
            }
            else
            {
