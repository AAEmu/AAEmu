...
public class CSMoveUnitPacket : GamePacket
{
    ...
    public override void Execute()
    {
        ...
        /*
        _logger.Debug("CSMoveUnitPacket(" + _moveType.Type + ") \nScType: " + _moveType.ScType + " - Flags: " +
        ...
        */
        ...
        switch (_moveType)
        {
            case ShipRequestMoveType srmt:
                {
                    ...
                    // _logger.Debug("ShipRequestMoveType - Throttle: {0} - Steering {1}", srmt.Throttle, srmt.Steering);
            ...
            case VehicleMoveType vmt:
                {
                    ...
                    /*
                    _logger.Debug("VehicleMoveType AngleVelocity XYZ: " + vmt.AngVelX.ToString("F1") + " , " +
            ...
            case UnitMoveType dmt:
                {
                    /*
                    _logger.Debug("ActorFlags: 0x{0} - ClimbData: {1} - GcId: {2}", 
                    ...
                    */
                    ...
                    else
                    {
                        ...
                        if (dmt.GcId == 1)
                        {
                            // _logger.Warn($"Flags: {dmt.Flags}, GcId: {dmt.GcId}, ClimbData: {dmt.ClimbData}, PartId: {dmt.GcPartId} ?");
                            parentObject = null;
                        }
                        ...
                        {
                            //_logger.Warn($"No longer standing on object {targetUnit.Transform.Parent.GameObject}...");
                    ...
                    */
                    ...
                    //_logger.Info($"SetPosition:World {targetUnit.ObjId} is moving X={targetUnit.Transform.World.Position.X} Y={targetUnit.Transform.World.Position.Y}");
                    //_logger.Info($"SetPosition:Local {targetUnit.ObjId} is moving X={dmt.X} Y={dmt.Y}");
