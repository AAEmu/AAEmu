...
public static class CSOffsets
{
    ...
    public const ushort CSChangeMateNamePacket = 0x0FC; // off_39C02F58
    ...
    public const ushort CSTeleportEndedPacket = 0x116;
    //public const ushort CSAesXorKeyPacket = 0x03F;
    ...
    public const ushort CSSpawnSlavePacket = 0x1A1; // off_39C39504
    ...
    public const ushort CSDiscardSlavePacket = 0x10C; // off_39C39534
    ...
    public const ushort CSAbilityPacket = 0x0D3; // off_39C3B564
    ...
    public const ushort CSSkillPacket = 0x132; // off_39C3BABC
    ...
    public const ushort CSSpecialtyRatioPacket = 0x07E; // off_39C3D5C8
    public const ushort CSListSpecialtyGoodsPacket = 0x07C; // off_39C3D60C
    ...
    public const ushort CSSellBackpackGoodsPacket = 0x14F; // off_39C544F4
