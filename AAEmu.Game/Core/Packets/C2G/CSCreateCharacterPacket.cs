...
{
    // 10.0.2.13 CSCreateCharacter (opcode 0x049) body. Layout follows the client
    // serializer CreateCharacterPacket::SerializeBody:
    //   name        : string
    //   CharRace    : u8   (NOTE: client serializes race/gender/ability/level as 1 byte, not u32)
    //   CharGender  : u8
    //   bodyItems   : u32 x7   ("type")
    //   appearance  : variable-length CustomModel (ext flag, face, hair, decals, sliders)
    //   ability1..3 : u8 x3
    //   level       : u8
    //   introZoneId : u32
    ...
    public override void Read(PacketStream stream)
    {
        ...
        // TODO: decode the appearance blob into UnitCustomModelParams for proper round-trip.
