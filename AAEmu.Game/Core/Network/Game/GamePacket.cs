...
namespace AAEmu.Game.Core.Network.Game
{
    public abstract class GamePacket : PacketBase<GameConnection>
    {
        ...
        public override PacketStream Encode()
        {
            ...
            if (!(TypeId == 0x013 && Level == 2) && !(TypeId == 0x066 && Level == 1) && !(TypeId == 0x068 && Level == 1) && !(TypeId == 0x016 && Level == 2))
        ...
        {
            if (!(TypeId == 0x012 && Level == 2) && !(TypeId == 0x089 && Level == 1) && !(TypeId == 0x015 && Level == 2))
