...
public class LootGameData : Singleton<LootGameData>, IGameDataLoader
{
    ...
    public void Load(SqliteConnection connection)
    {
        ...
        using (var command = connection.CreateCommand())
        {
            ...
            command.CommandText = "SELECT id, `group`, item_id, drop_rate, min_amount, max_amount, loot_pack_id, grade_id, always_drop FROM loots ORDER BY `group` ASC, loot_pack_id ASC, drop_rate DESC";
            command.Prepare();
