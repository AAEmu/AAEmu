...
/// sea and abyss quests). The client reader LoadQuestActSupplyLeadershipPointDescs (x2game-dev.dll
/// FUN_39d45790) reads id and point. Character.ChangeGamePoints(Leadership) moves the current
