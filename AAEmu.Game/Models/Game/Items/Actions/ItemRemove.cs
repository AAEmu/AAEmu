...
/// 10.0.2.13 uses <see cref="ItemAction.Seize"/> to identify and clear the item's current slot.
/// </summary>
public class ItemRemove : ItemTask
{
    ...
    {
        _ = itemTemplateId; // Retained for call-site compatibility; Seize has no template id.
        _type = ItemAction.Seize;
        _itemId = itemId;
        _slotType = slotType;
        _slot = slotNumber;
