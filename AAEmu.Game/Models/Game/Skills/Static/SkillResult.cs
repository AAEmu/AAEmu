...
public static class SkillResultHelper
{
    ...
    public static SkillResult SkillResultErrorKeyToId(SkillResultKeys key)
    {
        return key switch
        {
            ...
            // Kind 128 has no symbol of its own: the client evaluator writes plain FAILURE (0x01).
            ...
            // Kind 127 reuses the leadership-total byte: the client evaluator writes 0x90 with
