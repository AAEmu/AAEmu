        ...
        public bool Execute(Unit caster, SkillCaster skillCaster, Unit target, SkillCastTarget skillCastTarget, SkillObject skillObject)
        {
            ...
            switch (Kind)
            {
                case PlotConditionType.Level:
                    res = ConditionLevel(caster, skillCaster, target, skillCastTarget, skillObject, Param1, Param2, Param3);
                    break;
                case PlotConditionType.Relation:
                    res = ConditionRelation(caster, skillCaster, target, skillCastTarget, skillObject, Param1, Param2, Param3);
                    break;
                case PlotConditionType.Direction:
                    res = ConditionDirection(caster, skillCaster, target, skillCastTarget, skillObject, Param1, Param2, Param3);
                    break;
                case PlotConditionType.BuffTag:
                    res = ConditionBuffTag(caster, skillCaster, target, skillCastTarget, skillObject, Param1, Param2,
                        Param3);
                    break;
                case PlotConditionType.WeaponEquipStatus:
                    res = ConditionWeaponEquipStatus(caster, skillCaster, target, skillCastTarget, skillObject, Param1, Param2, Param3); 
                    break;
                case PlotConditionType.Chance:
                    res = ConditionChance(caster, skillCaster, target, skillCastTarget, skillObject, Param1, Param2,
                        Param3);
                    break;
                case PlotConditionType.Dead:
                    res = ConditionDead(caster, skillCaster, target, skillCastTarget, skillObject, Param1, Param2,
                        Param3);
                    break;
                case PlotConditionType.CombatDiceResult:
                    res = ConditionCombatDiceResult(caster, skillCaster, target, skillCastTarget, skillObject, Param1, Param2,
                        Param3); // Every CombatDiceResult is a NotCondition -> false makes it true. 
                    break;
                case PlotConditionType.InstrumentType:
                    res = ConditionInstrumentType(caster, skillCaster, target, skillCastTarget, skillObject, Param1, Param2,
                        Param3);
                    break;
                case PlotConditionType.Range:
                    res = ConditionRange(caster, skillCaster, target, skillCastTarget, skillObject, Param1, Param2,
                        Param3);
                    break;
                case PlotConditionType.Variable:
                    res = ConditionVariable(caster, skillCaster, target, skillCastTarget, skillObject, Param1, Param2, Param3);
                    break;
                case PlotConditionType.UnitAttrib:
                    res = ConditionUnitAttrib(caster, skillCaster, target, skillCastTarget, skillObject, Param1, Param2,
                        Param3);
                    break;
                case PlotConditionType.Actability:
                    res = ConditionActability(caster, skillCaster, target, skillCastTarget, skillObject, Param1, Param2,
                        Param3);
                    break;
                case PlotConditionType.Stealth:
                    res = ConditionStealth(caster, skillCaster, target, skillCastTarget, skillObject, Param1, Param2,
                        Param3);
                    break;
                case PlotConditionType.Visible:
                    res = ConditionVisible(caster, skillCaster, target, skillCastTarget, skillObject, Param1, Param2,
                        Param3);
                    break;
                case PlotConditionType.ABLevel:
                    res = ConditionABLevel(caster, skillCaster, target, skillCastTarget, skillObject, Param1, Param2,
                        Param3);
                    break;
            }
