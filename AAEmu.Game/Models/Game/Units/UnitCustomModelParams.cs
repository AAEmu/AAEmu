...
// 10.0.2.13 face customization tier (binary LobbyChar_WriteAppearance 0x393881E0 T3 block, names from the
// model-param dumper 0x394ADEF0). Wire order: movable face-decal transform, then a pish/pisc group of the 6
...
public class FaceModel : PacketMarshaler
{
    ...
    {
        // movable face-decal transform (binary sub_39388120)
...
// 10.0.2.13 appearance block (binary LobbyChar_WriteAppearance 0x393881E0). A leading `ext` byte
