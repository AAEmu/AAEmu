...
namespace AAEmu.Game.Models.Tasks.Skills
{
    public class EndChannelingTask : SkillTask
    {
        ...
        public EndChannelingTask(Skill skill, IUnit caster, SkillCaster casterCaster, IBaseUnit target, SkillCastTarget targetCaster, SkillObject skillObject, Doodad channelDoodad) : base(skill)
        {
            _caster = caster;
