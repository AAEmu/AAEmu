        ...
        public void Execute(Character character, string[] args)
        {
            ...
            if (targetPlayer != null)
            {
                if(targetPlayer.Hp == 0)
                {
                    ...
                    targetPlayer.BroadcastPacket(new SCCharacterResurrectedPacket(targetPlayer.ObjId, targetPlayer.Transform.World.Position.X, targetPlayer.Transform.World.Position.Y, targetPlayer.Transform.World.Position.Z, targetPlayer.Transform.World.ToYawPitchRoll().Z), true);
